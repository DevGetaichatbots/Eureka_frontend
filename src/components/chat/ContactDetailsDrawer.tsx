...
export function ContactDetailsDrawer({
  ...
  return (
    <>
      ...
      <aside className="fixed top-0 right-0 bottom-0 z-50 w-full sm:w-88 lg:static lg:w-80 lg:z-auto flex-shrink-0 bg-white border-l border-[#E5E7EB] flex flex-col h-full overflow-y-auto select-none shadow-2xl lg:shadow-none animate-in slide-in-from-right duration-200">
        {/* Header */}
        <div className="p-4 border-b border-[#E5E7EB] flex items-center justify-between sticky top-0 bg-white z-10">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[#FDEBEC] text-[#D92228] border border-[#F5C2C4] whitespace-nowrap">
              CRM Profile
            </span>
          </div>
        ...
        <div className="p-5 space-y-6">
          ...
          <div className="text-center">
            <div className="relative inline-block mx-auto mb-3">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-[#FDEBEC] text-[#D92228] font-extrabold text-2xl sm:text-3xl flex items-center justify-center border border-[#F5C2C4] shadow-xs">
