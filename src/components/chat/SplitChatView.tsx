              ...
              <div className="flex items-center justify-between gap-2 sm:gap-4 min-w-0">
                ...
                <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-1.5 sm:px-2.5 sm:py-1.5 rounded-xl text-xs font-semibold border border-[#E5E7EB] text-[#1A1A1A] hover:text-[#D92228] hover:bg-[#FDEBEC] hover:border-[#F5C2C4] transition-colors cursor-pointer disabled:opacity-60"
                  ...
                  <select
                    ...
                    className={`pl-2 pr-1 sm:pl-2.5 sm:pr-2 py-1.5 rounded-xl border text-[11px] sm:text-xs font-semibold focus:outline-none focus:ring-1 focus:ring-[#D92228] cursor-pointer transition-colors max-w-[100px] sm:max-w-none truncate ${
                      messageRange !== 'all'
